...
//        System.out.println(new_england_patriots.compareTo(dallas_cowboys));
        ...
        footballLeague.addTeam(ny_giants);
        footballLeague.addTeam(los_angeles_rams);
        footballLeague.addTeam(new_england_patriots);
        footballLeague.addTeam(dallas_cowboys);
//        footballLeague.addTeam(ac_milan);
